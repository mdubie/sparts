...
return (new CustomEvent(event_name,(function (){var obj27128 = ({"detail":data});
return obj27128;
})()));
} else {
...
if(cljs.core.truth_(((figwheel.client.utils.html_env_QMARK_.call(null))?(function (){var and__4109__auto__ = goog.object.get(window,"CustomEvent");
...
var f = (function (){var pred__27135 = cljs.core._EQ_;
var expr__27136 = ((figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__27135.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__27136))){
return (function (p1__27129_SHARP_){
return console.warn(p1__27129_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27135.call(null,new cljs.core.Keyword(null,"debug","debug",-1608172596),expr__27136))){
return (function (p1__27130_SHARP_){
return console.debug(p1__27130_SHARP_);
});
} else {
if(cljs.core.truth_(pred__27135.call(null,new cljs.core.Keyword(null,"error","error",-978969032),expr__27136))){
return (function (p1__27131_SHARP_){
return console.error(p1__27131_SHARP_);
});
} else {
return (function (p1__27132_SHARP_){
return console.log(p1__27132_SHARP_);
});
}
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__27139){
...
var eval_fn = cljs.core.get.call(null,map__27140__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
f.call(null,val,(function (p1__27142_SHARP_){
return new_def.callback(p1__27142_SHARP_);
}));
...
return cljs.core.mapv.call(null,(function (p__27143){
var vec__27144 = p__27143;
var ky = cljs.core.nth.call(null,vec__27144,(0),null);
...
//# sourceMappingURL=utils.js.map?rel=1609259929806
