...
var G__26799 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__26799;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__26800 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26800,ch);
...
if(("\\" === ch__$1)){
var ch_26801__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_26801__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_26801__$2);
} else {
}

var G__26802 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__26802;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__4120__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__4120__auto__){
return or__4120__auto__;
} else {
var or__4120__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__26810 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26810,(0),null);
var start_column = cljs.core.nth.call(null,vec__26810,(1),null);
...
var G__26813 = cljs.core.conj_BANG_.call(null,a,form);
a = G__26813;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__26814 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__26815 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__26815);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__26814);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__26816 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26816,(0),null);
var start_column = cljs.core.nth.call(null,vec__26816,(1),null);
...
var vec__26819 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26819,(0),null);
var end_column = cljs.core.nth.call(null,vec__26819,(1),null);
...
var vec__26822 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26822,(0),null);
var start_column = cljs.core.nth.call(null,vec__26822,(1),null);
...
var vec__26825 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26825,(0),null);
var end_column = cljs.core.nth.call(null,vec__26825,(1),null);
...
var vec__26828 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26828,(0),null);
var start_column = cljs.core.nth.call(null,vec__26828,(1),null);
...
var vec__26831 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26831,(0),null);
var end_column = cljs.core.nth.call(null,vec__26831,(1),null);
...
var or__4120__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__26836 = (function (){var G__26835 = sb;
G__26835.append(ch);
...
switch (G__26840) {
case "\\":
var G__26844 = (function (){var G__26841 = sb;
G__26841.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__26841;
})();
var G__26845 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__26844;
ch = G__26845;
continue;
...
break;
default:
var G__26846 = (function (){var G__26842 = sb;
G__26842.append(ch);
...
var vec__26848 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26848,(0),null);
var end_column = cljs.core.nth.call(null,vec__26848,(1),null);
...
var vec__26851 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26851,(0),null);
var column = cljs.core.nth.call(null,vec__26851,(1),null);
...
var or__4120__auto__ = cljs.tools.reader.resolve_alias.call(null,sym);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var vec__26856 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26856,(0),null);
var column = cljs.core.nth.call(null,vec__26856,(1),null);
...
var vec__26861 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__26861,(0),null);
var column = cljs.core.nth.call(null,vec__26861,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__26866 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__26866,(0),null);
var start_column = cljs.core.nth.call(null,vec__26866,(1),null);
...
var vec__26869 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__26869,(0),null);
var end_column = cljs.core.nth.call(null,vec__26869,(1),null);
...
var G__26872 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__26872,true,null,opts,pending_forms);
...
var G__26873 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__26873)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__26873)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__26873)){
...
var _STAR_suppress_read_STAR__orig_val__26874 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26875 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26875);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26874);
}});
...
var G__26876 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__26876,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__26876,rdr,first_line);

return G__26876;
} else {
var or__4120__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var G__26880 = matched;
var G__26881 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__26880;
finished = G__26881;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__4109__auto__ = opts;
if(cljs.core.truth_(and__4109__auto__)){
...
var _STAR_suppress_read_STAR__orig_val__26882 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__26883 = (function (){var or__4120__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__26883);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__26882);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__26884 = cljs.tools.reader.arg_env;
var arg_env_temp_val__26885 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__26885);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__26886 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__26886,"(");
...
var G__26887 = (i + (1));
var G__26888 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4120__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__26884);
}});
/**
...
var ch = temp__5733__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__26889 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__26889);
...
var G__26890 = cljs.core.next.call(null,s__$1);
var G__26891 = ret;
s__$1 = G__26890;
r = G__26891;
continue;
...
var G__26892 = cljs.core.next.call(null,s);
var G__26893 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__26892;
key_vals = G__26893;
continue;
} else {
...
var or__4120__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__4120__auto__)){
return or__4120__auto__;
} else {
...
var gensym_env_orig_val__26898 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__26899 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__26899);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__26898);
}});
...
var temp__5733__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__26900 = token;
var G__26900__$1 = (((G__26900 == null))?null:cljs.core.subs.call(null,G__26900,(1)));
var G__26900__$2 = (((G__26900__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26900__$1));
var G__26900__$3 = (((G__26900__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26900__$2));
var G__26900__$4 = (((G__26900__$3 == null))?null:cljs.core.symbol.call(null,G__26900__$3));
if((G__26900__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__26900__$4);
}
})():(function (){var G__26901 = token;
var G__26901__$1 = (((G__26901 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__26901));
if((G__26901__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__26901__$1);
}
})()
));
if(cljs.core.truth_(temp__5733__auto__)){
...
}catch (e26908){if((e26908 instanceof Error)){
var e = e26908;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__26912,reader){
...
var eof = cljs.core.get.call(null,map__26913__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
...
//# sourceMappingURL=reader.js.map?rel=1609259929551
