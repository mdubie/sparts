...
return m__4423__auto__.call(null,reader);
} else {
var m__4420__auto__ = (cljs.tools.reader.reader_types.read_char["_"]);
if((!((m__4420__auto__ == null)))){
return m__4420__auto__.call(null,reader);
} else {
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_26685.call(null,reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_26686 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_26686.call(null,reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26687 = (function (reader,ch){
var x__4422__auto__ = (((reader == null))?null:reader);
var m__4423__auto__ = (cljs.tools.reader.reader_types.unread[goog.typeOf(x__4422__auto__)]);
if((!((m__4423__auto__ == null)))){
return m__4423__auto__.call(null,reader,ch);
} else {
var m__4420__auto__ = (cljs.tools.reader.reader_types.unread["_"]);
if((!((m__4420__auto__ == null)))){
return m__4420__auto__.call(null,reader,ch);
} else {
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_26687.call(null,reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26688 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_26688.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26689 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_26689.call(null,reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26690 = (function (reader){
var x__4422__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_26690.call(null,reader);
}
});
...
return cljs.core._write.call(null,writer__4364__auto__,"cljs.tools.reader.reader-types/StringReader");
}));
...
return cljs.core._write.call(null,writer__4364__auto__,"cljs.tools.reader.reader-types/NodeReadableReader");
}));
...
return cljs.core._write.call(null,writer__4364__auto__,"cljs.tools.reader.reader-types/PushbackReader");
}));
...
return cljs.core._write.call(null,writer__4364__auto__,"cljs.tools.reader.reader-types/IndexingPushbackReader");
}));
...
return cljs.core._write.call(null,writer__4364__auto__,"cljs.tools.reader.reader-types/SourceLoggingPushbackReader");
}));
...
var G__26701 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
var G__26702 = s.append(c);
c = G__26701;
s = G__26702;
continue;
}
...
//# sourceMappingURL=reader_types.js.map?rel=1609259929233
